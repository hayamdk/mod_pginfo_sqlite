...
gcc -Wall -Ofast -march=native -fpic -flto -finput-charset=cp932 -I./ -D IN_SHARED_MODULE -c utils/ts_parser.c
...
gcc -Wall -shared -fpic -flto -o mod_pginfo_sqlite.so tsdstr.o path.o ts_parser.o aribstr.o mod_pginfo_sqlite.o ${LD_FLAGS}
rm -f tsdstr.o path.o ts_parser.o aribstr.o mod_pginfo_sqlite.o