...
#undef TSD_API_DEF
#define TSD_API_DEF(type, name, args) tsd_api_set.name = name
tsd_api_set_t tsd_api_set;
void tsd_api_init_set()
{
#include "core/module_hooks.h"
}
#endif
...
#define TSD_MODULE_DEF(name, reg_hooks, cmds, ...) \
